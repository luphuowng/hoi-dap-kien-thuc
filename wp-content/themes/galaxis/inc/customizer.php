	...
	$wp_customize->add_control(
		new Galaxis_Upsell_Control(
			...
			array(
				...
				'url'         => 'https://scriptstown.com/wordpress-themes/galaxis-premium-wordpress-theme/',
				'priority'    => 999,
		...
		array(
			...
			'description' => wp_kses(
				sprintf(
					...
					__( 'This is the content of the footer block area. You can create or edit the footer block area in the <a href="%s" target="_blank">Reusable Blocks Manager (opens in a new window)</a>.<br>The selected block content will appear on the footer block area.', 'galaxis' ),
	...
	$wp_customize->add_control(
		new Galaxis_Upsell_Control(
			...
			array(
				...
				'type'        => 'galaxis-addon',
				'label'       => esc_html__( 'Learn More', 'galaxis' ),
				'description' => esc_html__( 'More options like footer widgets area, etc. are available for this section in our premium version.', 'galaxis' ),
				'url'         => 'https://scriptstown.com/wordpress-themes/galaxis-premium-wordpress-theme/',
				'priority'    => 999,
				'settings'    => ( isset( $wp_customize->selective_refresh ) ) ? array() : 'blogname',
			)
